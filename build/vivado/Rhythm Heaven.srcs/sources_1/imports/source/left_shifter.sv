...
module left_shifter (
    ...
    localparam _MP_SHIFT_2024120994 = 5'h10;
    localparam _MP_SIZE_2024120994 = 6'h20;
    ...
    x_bit_left_shifter #(
        .SHIFT(_MP_SHIFT_2024120994),
        .SIZE(_MP_SIZE_2024120994)
    ) shifter16 (
        .a(M_shifter16_a),
    ...
    localparam _MP_SHIFT_1913967936 = 4'h8;
    localparam _MP_SIZE_1913967936 = 6'h20;
    ...
    x_bit_left_shifter #(
        .SHIFT(_MP_SHIFT_1913967936),
        .SIZE(_MP_SIZE_1913967936)
    ) shifter8 (
        .a(M_shifter8_a),
    ...
    localparam _MP_SHIFT_1420670474 = 3'h4;
    localparam _MP_SIZE_1420670474 = 6'h20;
    ...
    x_bit_left_shifter #(
        .SHIFT(_MP_SHIFT_1420670474),
        .SIZE(_MP_SIZE_1420670474)
    ) shifter4 (
        .a(M_shifter4_a),
    ...
    localparam _MP_SHIFT_1638630721 = 2'h2;
    localparam _MP_SIZE_1638630721 = 6'h20;
    ...
    x_bit_left_shifter #(
        .SHIFT(_MP_SHIFT_1638630721),
        .SIZE(_MP_SIZE_1638630721)
    ) shifter2 (
        .a(M_shifter2_a),
    ...
    localparam _MP_SHIFT_1916215147 = 1'h1;
    localparam _MP_SIZE_1916215147 = 6'h20;
    ...
    x_bit_left_shifter #(
        .SHIFT(_MP_SHIFT_1916215147),
        .SIZE(_MP_SIZE_1916215147)
    ) shifter1 (
        .a(M_shifter1_a),
